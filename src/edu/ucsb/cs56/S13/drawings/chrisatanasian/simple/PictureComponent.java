package edu.ucsb.cs56.S13.drawings.chrisatanasian.simple;
...
/**
   ...
   @author Chris Atanasian (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Chris Atanasian", 20,40);
    }
