package edu.ucsb.cs56.S13.drawings.kreimer.simple;
...
/**
   ...
   @author Keenan Reimer (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Keenan Reimer", 20,40);
    }
