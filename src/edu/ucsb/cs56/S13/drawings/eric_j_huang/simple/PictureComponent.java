...
/**
   ...
   @author Eric Huang (fixed the snowmans's head)
...
{  
	...
	final double snowManCenterBottomY = 280;
	
	// I made some change to the coordinate of bottomY due to
	// personal preferences, the code still draw the same picture
	...
	Circle snowManMiddleCircle = 
	    ...
	    (
	     snowManCenterBottomX,
	     snowManCenterBottomY - bottomRadius - middleRadius,
	     middleRadius
	     );
	...
	g2.drawString("Top of snowman added by Eric Huang", 20,40);
    }    
}
